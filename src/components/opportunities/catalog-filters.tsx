...
/**
 * The controls that aren't dropdowns. A catalog opts into each one by carrying
 * its key in the filter state; Programas e Bolsas, for instance, has an age
 * but no deadline window and no verified set.
 */
...
function CatalogFilters<F extends CatalogFilterValues>({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {filtros.apenasVerificadas !== undefined && (
